...
BEGIN
    ...
    INSERT INTO dbo.PersonMedication (PersonId, MedicationName, Dosage, Frequency, Route, StartDate, EndDate, Indication, Notes, Status, PrescriberName, CreationDate)
    VALUES (@PersonId, @MedicationName, @Dosage, @Frequency, @Route, ISNULL(@StartDate, GETDATE()), @EndDate, @Indication, @Notes, @Status, @PrescriberName, GETDATE());
