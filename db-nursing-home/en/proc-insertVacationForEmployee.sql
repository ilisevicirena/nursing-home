...
BEGIN
	...
	DECLARE @Title varchar(200) = 'Vacation: ' + @FirstName + ' ' + @LastName;
	DECLARE @Description varchar(max) = 'Employee vacation: ' + @FirstName + ' ' + @LastName + ' ' + CONVERT(varchar(10), @FromDate, 104) + ' - '+CONVERT(varchar(10), @ToDate, 104);
