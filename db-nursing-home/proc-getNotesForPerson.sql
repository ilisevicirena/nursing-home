...
/****** Object:  StoredProcedure [dbo].[getNotesForPerson]    Script Date: 2.6.2023. 11:35:54 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	gets notes for person
-- =============================================
CREATE PROCEDURE [dbo].[getNotesForPerson]
...
BEGIN
	...
	where n.PersonId=@PersonId and nt.Active=1;
