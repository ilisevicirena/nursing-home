...
export class DocumentsService extends BaseRestApiService {
  ...
  public getDocumentsForPerson(id: number): Observable<any> {
    return this.http.get(
      this.apiRoute + "/getDocumentsForPerson?PersonId=" + id
    );
  }

  public getDocumentsForPersonByType(
    id: number,
    typeId: number
  ): Observable<any> {
    return this.http.get(
      this.apiRoute +
        "/getDocumentsForPersonByType?PersonId=" +
        id +
        "&DocumentTypeId=" +
        typeId
    );
  ...
  public getDocumentContent(id: number): Observable<any> {
    return this.http.get(
      this.apiRoute + "/getDocumentContent?DocumentId=" + id
    );
  }

  public getDocumentTypesForPerson(id: number): Observable<any> {
    return this.http.get(
      this.apiRoute + "/getDocumentTypesForPerson?PersonId=" + id
    );
  }
}
