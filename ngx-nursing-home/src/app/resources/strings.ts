...
const strings: IKeyValue[] = [
  ...
  {
    key: "noRoomsForSelectedFloor",
    value: "Nema spremljenih soba za odabrani kat!",
  },
  ...
  {
    key: "unactiveTooltip",
    value: "Osoba je bila smještena u ustanovi, ali je njen boravak završio.",
  },
  ...
  { key: "room", value: "Soba" },
  {
    key: "goToExternalRoomManagement",
    value: "Idi na vanjsko upravljanje smještajem",
  },
  ...
  {
    key: "activePersonDetails",
    value: "Aktivna osoba je osoba koja je trenutno smještena u ustanovi.",
  },
  {
    key: "unactivePersonDetails",
    value: "Neaktivna osoba je osoba čiji je boravak u ustanovi završio.",
  },
  {
    key: "changeStatusPersonText1",
    value:
      "Za prebacivanje osobe iz statusa aktivne u neaktivnu potrebno je kliknuti gumb: ",
  },
  {
    key: "changeStatusPersonText2",
    value:
      "Ukoliko ne navedete 'Datum odlaska' spremit će se trenutni datum kao datum odlaska osobe iz ustanove.",
  },
  { key: "unactivePersons", value: "Prikaži neaktivne osobe" },
  { key: "areYouSure", value: "Jeste li sigurni?" },
  {
    key: "questionDeactivatePerson",
    value: "Želite li deaktivirati osobu s datumom: ",
  },
  { key: "yes", value: "Da" },
  { key: "no", value: "Ne" },
  ...
  {
    key: "basicPersonStepText",
    value:
      "Ovdje popunite osnovne podatke o novoj osobi. Nakon unosa, klikom na gumb za dodavanje nove osobe, osoba je dodana u sustav. U daljnim koracima možete (ne morate) popuniti neke dodatne podatke o novom korisniku doma, na primjer: unijeti kontakt osobe, dodijeliti sobu za smještaj, bilješke, dokumente i slično.",
  },
  ...
  {
    key: "contactsPersonStepText",
    value:
      "Ovdje popunite podatke o kontakt osobama. Možete navesti više kontakt osoba, te za svaku osobu popuniti neku vrstu kontakta (e-mail, telefonski broj ili mobilni broj). Za svaki kontakt obavezno je unijeti ime i prezime.",
  },
  ...
  {
    key: "savePersonFirst",
    value: "Za unos prvo spremite osnovne podatke o osobi!",
  },
  {
    key: "accomodationPersonStepText",
    value:
      "Ovdje popunite podatke o smještaju nove osobe. Osobu možete smjestiti samo u sobu u kojoj ima slobodnog mjesta. U jednoj sobi mogu biti smještene samo osobe istoga spola (obratite pažnju ukoliko već imate osobu u odabranoj sobi!). Podatke možete uređivati i sa portala za upravljanje smještajem.",
  },
  { key: "address", value: "Adresa" },
  { key: "gender", value: "Spol" },
  { key: "freeSpace", value: "Slobodno" },
  {
    key: "roomSelectionInvalid",
    value:
      "Ne možete u istoj sobi imati dodjeljene osobe različitih spolova. U tablici pod stupcem 'Spol' naveden je spol osoba koje su trenutno smještene u sobu.",
  },
  ...
  {
    key: "typeSearchTerm",
    value: "Za pretraživanje po unesenom pojmu pritisnite ENTER",
  },
  ...
  {
    key: "defaultNumberOfUnitsInfo",
    value:
      "Kada koristite fiksnu količinu jedinica pri dodavanju usluge u paket, koristi se uneseni broj jedinica i obračunava na temelju unesene cijene po jedinici. Količinu nije moguće mijenjati prilikom dodavanja stavke u obračun.",
  },
  ...
  {
    key: "deactivatePackage",
    value: "Želite li ukloniti paket usluga iz ponude?",
  },
  ...
  {
    key: "offerPersonStepText",
    value:
      "Ovdje možete odabrati pakete usluga za novu osobu. Paket i usluge možete dodati i naknadno na portalu za pregled podataka o osobi. Odabrane pakete i usluge možete poslije izmijeniti. Nakon odabira ponude nemojte zaboraviti spremiti podatke!",
  },
  ...
  {
    key: "wantToSaveOffer",
    value: "Sigurno želiš spremiti promjene u paketu usluga?",
  },
  ...
  {
    key: "startDoctorVisit",
    value: "Pokretanje akcije liječničkog obilaska za sve aktivne osobe",
  },
  { key: "delete", value: "Obriši" },
  { key: "completed", value: "Dovršeno" },
  { key: "completed", value: "Dovršeno" },
  {
    key: "documentsPersonStepText",
    value:
      "Ovdje možeš dodati neke dokumente vezane uz novu osobu (kopije osobnih dokumenata, upute za davanje lijekova, liječničke nalaze i slično). Dodane dokumente možeš kasnije pregledati i uređivati unutar profila osobe. Dokumente ne moraš dodati odmah...",
  },
  { key: "uploadDocument", value: "Dodaj dokument" },
  {
    key: "startCalculation",
    value: "Pokretanje obračuna za sve aktivne osobe",
  },
  { key: "calculationPage", value: "Obračun" },
  { key: "calculationFor", value: "Obračun za" },
  { key: "newCalculation", value: "Novi obračun" },
  {
    key: "startingCalculation",
    value: "Pokretanje obračuna za sve aktivne osobe",
  },
  { key: "daysForPayment", value: "Rok za uplatu (dani)" },
  {
    key: "recalculateForExisting",
    value: "Preračunaj za osobe koje već imaju obračun u odabranom razdoblju",
  },
  {
    key: "skipExisting",
    value:
      "Kreiraj obračun samo za osobe koje nemaju obračun u odabranom razdoblju",
  },
  { key: "start", value: "Pokreni" },
  {
    key: "calculationInProgress",
    value:
      "Kalkulacija je u tijeku, molimo pričekajte (može potrajati nekoliko minuta)",
  },
  ...
  { key: "invoicePeriod", value: "Razdoblje: " },
  {
    ...
    value:
      "Napomena: Ovaj dokument automatski je generiran iz sustava i može se razlikovati od stvarnog stanja!",
  },
  ...
  {
    key: "markRealPrice",
    value: "Unesi izračunati iznos kao stvarni za odabrane",
  },
  ...
  {
    key: "wantToMarkRealPrice",
    value:
      "Želite li unijeti izračunati iznos kao stvarni iznos za odabrane obračune?",
  },
  {
    key: "wantToMarkPaid",
    value:
      "Želite li označiti odabrane obračune kao plaćene? Unijet će se stvarni iznos kao plaćeni, ako stvarni iznos nije unsen iskoristit će se izračunati iznos. Datum plaćanja će biti trenutni datum.",
  },
  {
    key: "wantToCancelSelected",
    value:
      "Želite li stornirati plaćanje obračuna? Stornirani obračuni ne ulaze u računanje ukupnih iznosa.",
  },
  ...
  {
    key: "cancelledCalculationsDescription",
    value:
      "Stornirani obračuni izuzeti su iz ukupnog izračunatog, stvarnog i plaćenog iznosa.",
  },
  ...
  {
    key: "calculationDocuments",
    value: "Pregledaj dokumente vezane uz obračun",
  },
  {
    key: "wantToCancelCalculation",
    value:
      "Sigurno želiš stornirati obračun? Nakon storniranja obračun više ne ulazi u izračun ukupnog iznosa.",
  },
  ...
  {
    key: "calculationInfoPopover",
    value:
      "Ukoliko paket ima unesenu prilagođenu cijenu, konačna cijena paketa je jednaka prilagođenoj cijeni. Ukoliko paket ima izračunatu cijenu, cijena se računa temeljem usluga koje obuhvaća paket (uporabom cijena i količina usluga).",
  },
  ...
  { key: "employeesManagement", value: "Upravljanje zaposlenicima" },
  { key: "employees", value: "Zaposlenici" },
  { key: "addEmployee", value: "Unos novog zaposlenika" },
  { key: "unactiveEmployees", value: "Prikaži neaktivne zaposlenike" },
  { key: "jobPosition", value: "Radno mjesto" },
  { key: "employmentDate", value: "Datum zaposlenja" },
  { key: "addressAndContact", value: "Adresa & kontakt" },
  { key: "experianceAndEducation", value: "Obrazovanje i iskustvo" },
  { key: "qualification", value: "Stručna sprema" },
  { key: "schoolQualificationName", value: "Zanimanje" },
  { key: "yearsOfExperiance", value: "Godine iskustva" },
  { key: "schoolName", value: "Naziv školske ustanove" },
  { key: "employmentType", value: "Vrsta zaposlenja" },
  { key: "bankName", value: "Naziv banke u kojoj ima otvoren račun" },
  { key: "bankAccountNumber", value: "Broj bankovnog računa" },
  { key: "daysOfVacation", value: "Broj dana godišnjeg odmora" },
  { key: "saveNewEmployee", value: "Spremi novog zaposlenika" },
  ...
  { key: "employeesByGender", value: "Udio zaposlenika po spolu" },
  { key: "currentEmployees", value: "Trenutno zaposlenika" },
  { key: "totalEmployees", value: "Ukupno zaposlenika" },
  ...
  { key: "doctorVisits", value: "Vizite" },
  { key: "doctors", value: "Liječnici" },
  { key: "nurses", value: "Medicinski djelatnici" },
  { key: "numberOfVisitedPersons", value: "Broj pregledanih korisnika" },
  { key: "doctorVisitDetails", value: "Detalji liječničke posjete" },
  { key: "visitDetails", value: "Osnovni podaci" },
  { key: "visitPersons", value: "Detalji liječničke posjete po korisniku" },
  { key: "visitSummary", value: "Sažetak i preuzimanja" },
  { key: "numberOfDoctors", value: "Broj liječnika" },
  { key: "numberOfNurses", value: "Broj medicinskog osoblja" },
  { key: "doctorVisitShort", value: "Liječnička posjeta" },
  { key: "visitPassedTime", value: "Proteklo vrijeme od zadnje posjete" },
  { key: "visitMonths", value: "MJESECI" },
  { key: "visitDays", value: "DANI" },
  { key: "visited", value: "Broj posjećenih osoba" },
  { key: "totalPersons", value: "UKUPNO OSOBA" },
  { key: "visitedPersons", value: "POSJEĆENO OSOBA" },
  { key: "basicStatistics", value: "Osnovna statistika" },
  { key: "doctorStatistics", value: "Statistika liječnika" },
  { key: "totalVisits", value: "Ukupan broj posjeta" },
  { key: "downloadAllNotes", value: "Preuzmi podatke o posjeti" },
  { key: "width", value: "Širina elementa" },
  { key: "height", value: "Visina elementa" },
  { key: "top", value: "Gornja pozicija" },
  { key: "left", value: "Lijeva pozicija" },
  {
    key: "personWithLongestLastVisit",
    value: "Najduže bez liječničke posjete",
  },
  ...
  { key: "furnitureStatuses", value: "Statusi namještaja" },
  { key: "furnitureManagement", value: "Upravljanje namještajem" },
  { key: "icon", value: "Ikona" },
